...
import cn.weegoo.common.utils.FileUtils;
import cn.weegoo.config.properties.WeeGooProperties;
import cn.weegoo.sys.model.FileData;
...
public class FileKit {
    ...
    public static String getFileDir(String fileUrl) {
        return (WeeGooProperties.newInstance ( ).getUserfilesBaseDir ( ) + fileUrl).replace ( "\\", "/" );
    }
    ...
    public static String transDirToUrl(String dir) {
        return dir.substring ( WeeGooProperties.newInstance ( ).getUserfilesBaseDir ( ).length ( ) );
    }
    ...
    public static String getShareBaseDir() {
        String dir = WeeGooProperties.newInstance ( ).getUserfilesBaseDir ( ) + WeeGooProperties.USERFILES_BASE_URL + "共享文档/";
    ...
    public static String getShareBaseUrl() {
        return WeeGooProperties.USERFILES_BASE_URL + "/共享文档/";
    }
    ...
    public static String getMyDocDir() {
        ...
        String dir = WeeGooProperties.newInstance ( ).getUserfilesBaseDir ( ) + WeeGooProperties.USERFILES_BASE_URL + id + "/我的文档/";
        FileUtils.createDirectory ( dir );
        return dir;
    }
    ...
    public static String getMyDocUrl() {
        String id = UserUtils.getCurrentUserDTO ( ).getId ( );
        return WeeGooProperties.USERFILES_BASE_URL + id + "/我的文档/";
    }
    ...
    public static String getAttachmentDir() {
        String id = UserUtils.getCurrentUserDTO ( ).getId ( );
        String dir = WeeGooProperties.newInstance ( ).getUserfilesBaseDir ( ) + WeeGooProperties.USERFILES_BASE_URL + id + "/程序附件/";
        FileUtils.createDirectory ( dir );
        return dir;
    }
    ...
    public static String getAttachmentUrl() {
        ...
        String id = UserUtils.getCurrentUserDTO ( ).getId ( );
        return WeeGooProperties.USERFILES_BASE_URL + id + "/程序附件/";
    }
